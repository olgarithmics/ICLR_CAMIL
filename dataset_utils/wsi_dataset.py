...
from wsi_core.util_classes import isInContourV1, isInContourV2, isInContourV3_Easy, \
    isInContourV3_Hard
...
class Wsi_Region():
    ...
    def __init__(self, wsi_object, top_left=None, bot_right=None, level=0,
        ...
        # self.neighbor_indices = np.argsort(patch_distances, axis=1)[:, :10 + 1]
